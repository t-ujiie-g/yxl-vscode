...
export const MODELED_KEYS = {
  ...
  chart: keySet(['at', 'type', 'title', 'legend', 'size', 'x_axis', 'y_axis', 'series']),
  chartSeries: keySet(['values', 'categories', 'name', 'name_from']),
  chartAxis: keySet(['title', 'min', 'max']),
  size: keySet(['width', 'height']),
  point: keySet(['x', 'y']),
  image: keySet(['at', 'file', 'alt', 'scale', 'offset', 'positioning']),
  shape: keySet(['at', 'kind', 'text', 'size', 'fill', 'line', 'alt', 'positioning']),
  shapeLine: keySet(['color', 'width']),
  shapeText: keySet(['text', 'font']),
  sparkline: keySet([
    'at',
    'data',
    'cells',
