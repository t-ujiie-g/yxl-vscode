...
/**
 * A whole spec as this editor models it (ADR-001). What is not modeled is in
 * `opaque`, per document and per sheet, and is never dropped or reformatted
 * (ADR-011); `date1904` is, because it decides what every date *is*.
 */
