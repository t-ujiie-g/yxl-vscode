...
/** Every file a spec is made of, as the reader has it: an applied `WorkspaceEdit` leaves the buffer dirty. */
...
/** Take the reader to a span, in whichever file it lives. */
