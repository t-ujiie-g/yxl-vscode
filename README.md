...
| **…and offers the answers, where it has them** | Where an edit has one meaning it is made — typing into a blank cell writes it, and the arrows, tab and delete work as they do anywhere else. Where it has several, they are listed with what each would change: a formula typed at a `formulas:` range's anchor can become *the range's* formula, and you are told it moves 40 cells before you agree to it. You pick; nothing is picked for you. |
